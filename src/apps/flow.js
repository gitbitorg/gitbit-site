...
const app = {
  ...
  'resources': [
    ...
    {
      'title': 'Twitter',
      'url': 'https://twitter.com/hashtag/MicrosoftFlow'
    },
    {
      'title': 'Roadmap',
      'url': 'https://products.office.com/en-us/business/office-365-roadmap?filters=%26freeformsearch=Flow'
    },
    {
      'title': 'User Training',
      'url': 'https://docs.microsoft.com/en-us/flow/'
    },
    {
      'title': 'YouTube',
      'url': 'https://www.youtube.com/channel/UCG98S4lL7nwlN8dxSF322bA'
    },
    {
      'title': 'UserVoice',
      'url': 'https://powerusers.microsoft.com/t5/Flow-Ideas/idb-p/FlowIdeas/tab/most-kudoed'
    }
  ],
  'competitors': [
    {
      ...
      'image': '/assets/icons/ifttt.png'
    },
    {
      'name': 'Zapier',
      'url': 'https://zapier.com/',
      'image': '/assets/icons/zapier.png'
    }
  ],
  'requests': [
    {
      'votes': 270,
      'title': 'Add the From field on the action "Send Approval email"'
    },
    {
      'votes': 260,
      'title': 'Trigger from Microsoft Teams'
    },
    {
      'votes': 240,
      'title': 'Need a Sharepoint trigger when a list item is deleted'
    },
    {
      'votes': 220,
      'title': 'set item level security in SharePoint'
    },
    {
      'votes': 220,
      'title': 'SharePoint Files - all fields not just a few'
    }
  ],
  'title': 'Microsoft Flow',
  'datePublished': '2018-06-07T06:00:00.000Z',
  'dateModified': '2018-06-07T06:00:00.000Z',
  'image1200x1200': '/apps/assets/flow-1200x1200.jpg',
  'image1200x900': '/apps/assets/flow-1200x900.jpg',
  'image1200x675': '/apps/assets/flow-1200x675.jpg',
  'image400x300': '/apps/assets/flow-400x300.jpg',
  'canonical': '/apps/flow',
