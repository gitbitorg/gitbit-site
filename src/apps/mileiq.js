...
const app = {
  ...
  'resources': [
    ...
    {
      'title': 'Twitter',
      'url': 'https://twitter.com/hashtag/MileIQ'
    },
    {
      'title': 'YouTube',
      'url': 'https://www.youtube.com/user/mileiq'
    },
    {
      'title': 'Wikipedia',
      'url': 'https://en.wikipedia.org/wiki/MileIQ'
    }
  ],
  'competitors': [
    {
      'name': 'Everlance',
      'url': 'https://everlance.com/',
      'image': '/assets/icons/everlance.png'
    },
    {
      'name': 'QuickBooks Mileage Tracker',
      'url': 'https://quickbooks.intuit.com/mileage-tracking/',
      'image': '/assets/icons/quickbooks-mileage-tracker.png'
    }
  ],
  'title': 'MileIQ',
  'datePublished': '2018-06-07T06:00:00.000Z',
  'dateModified': '2018-06-07T06:00:00.000Z',
  'image1200x1200': '/apps/assets/mileiq-1200x1200.jpg',
  'image1200x900': '/apps/assets/mileiq-1200x900.jpg',
  'image1200x675': '/apps/assets/mileiq-1200x675.jpg',
  'image400x300': '/apps/assets/mileiq-400x300.jpg',
  'canonical': '/apps/mileiq',
