...
const app = {
  ...
  'licenses': [
    ...
    'Dynamics 365 for Operations Activity, Ent Edition',
    'Dynamics 365 for Operations, Ent Edition device',
    'Dynamics 365 for Operations, Ent Edition device Device add-on for AX Task',
    'Dynamics 365 for Operations, Ent Edition device From SA for AX Task Device',
    'Dynamics 365 for Project Service Automation Enterprise Edition',
    'Dynamics 365 for Retail, Ent Edition',
    ...
    'Dynamics 365 for Talent, Ent Edition',
    'Dynamics 365 for Team Members Enterprise Edition',
    'Dynamics 365 Plan Enterprise Edition',
    'Dynamics 365 Unf Ops Plan, Ent Edition'
  ],
  'platforms': {
  ...
  'resources': [
    ...
    {
      'title': 'Twitter',
      'url': 'https://twitter.com/hashtag/Dynamics365'
    },
    {
      'title': 'Roadmap',
      'url': 'https://products.office.com/en-us/business/office-365-roadmap?filters=%26freeformsearch=Dyanmics'
    },
    {
      'title': 'User Training',
      'url': 'https://docs.microsoft.com/en-us/dynamics365/get-started/training/'
    },
    {
      'title': 'YouTube',
      'url': 'https://www.youtube.com/channel/UCJGCg4rB3QSs8y_1FquelBQ'
    },
    {
      'title': 'Wikipedia',
      'url': 'https://en.wikipedia.org/wiki/Dynamics_365'
    }
  ],
  'competitors': [
    {
    ...
    },
    {
      ...
      'url': '/apps/outlook-customer-manager',
      'image': '/assets/icons/outlook-customer-manager-96px.png'
    }
  ],
  'title': 'Dynamic 365',
  'datePublished': '2018-06-07T06:00:00.000Z',
  'dateModified': '2018-06-07T06:00:00.000Z',
  'image1200x1200': '/apps/assets/dynamics-365-1200x1200.jpg',
  'image1200x900': '/apps/assets/dynamics-365-1200x900.jpg',
  'image1200x675': '/apps/assets/dynamics-365-1200x675.jpg',
  'image400x300': '/apps/assets/dynamics-365-400x300.jpg',
  'canonical': '/apps/dynamics-365',
