module.exports = {
  ...
  competitors: [
    ...
    {name: 'Zoho Mail', url: 'https://www.zoho.com/mail/', image:'/assets/icons/zoho-mail.png'},
    {name: 'Exchange Server', url: 'https://products.office.com/en-us/exchange/microsoft-exchange-server-2016', image:'/assets/icons/exchange-2010.png'},
  ],
  compliance: {
  ...
  requests: [
    {votes: 1700, title:'Export mailbox in Exchange Online to pst using PowerShell or other method'},
    {votes: 1700, title:'Enable and disable Clutter from Admin Panel'},
    {votes: 1300, title:'GAL Federation between different O365 tenants'},
    {votes: 1200, title:'Delegate permissions for managing MFA'},
    {votes: 600, title:'Allow emails to be delayed in OWA'}
  ],
  'title': 'Exchange Online',
  'keywords': 'Office 365, Exchange Online',
  'assetsFolder': 'exchange-online',
  'fileName': 'Exchange-Online',
